...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+1 716-307-7455}{{\footnotesize\faPhone*}\hspace*{0.13cm}+1 716-307-7455}}%
        \kern 0.25 cm%
    ...
    \section{Objective}
        ...
        \begin{onecolentry}
            Looking for a RIT co-op opportunity (2026) in a Computer Science related field to apply and grow my skills as a software developer \end{onecolentry}
